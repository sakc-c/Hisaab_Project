...
urlpatterns = [
    ...
    path('profile/password_change/', auth_views.PasswordChangeView.as_view(success_url=reverse_lazy('profile'), template_name='hisaab/reset_password.html',), name='password_change'),
    ...
    path('delete-user/<int:user_id>/', views.delete_user, name='delete_user_page'),
